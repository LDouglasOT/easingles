...
class Confirmwithdraw extends StatefulWidget {
  ...
  Confirmwithdraw({required this.giftName});
...
class _ConfirmwithdrawState extends State<Confirmwithdraw> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: Toolbar(
          title: "Confirmwithdraw ${widget.giftName.name}",
                      ...
                      switch (response.statusCode) {
                        case 200:
                          var snackBar = SnackBar(
                            ...
                            content: FlutterSnackbarContent(
                              message:
                                  'Successfully redeemed ${counter.toString()} ${widget.giftName.name}, your request will be processed shortly.',
